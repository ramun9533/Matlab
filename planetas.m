...
%for k = 1:3
  for idx = 1:length(t)
      ...
      surf(xp+.5+p1(1,idx),yp+p1(2,idx),zp+.5+p1(3,idx),'FaceColor','b')
      surf(xp+1+p1(1,idx),yp+p1(2,idx),zp+p1(3,idx),'FaceColor','g')
      %plot3(p2(1,:),p2(2,:),p2(3,:),'b')
      %surf(xp+p2(1,idx),yp+p2(2,idx),zp+p2(3,idx),'FaceColor','b')
